        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white animate-fade-in">
            ...
            <p className="text-lg sm:text-xl md:text-2xl mb-12 text-white/90 max-w-3xl mx-auto">
              Viajar é mais do que conhecer lugares — é viver experiências únicas.<br />
              Com a GFChaves Travel Experience, cada viagem é pensada para ser memorável do início ao fim.
            </p>
